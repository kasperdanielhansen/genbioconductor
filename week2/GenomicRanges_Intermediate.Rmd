...
title: GenomicRanges - Intermediate Usage
fontsize: 10pt
---
...
Here we will work on expanding our understanding of `r Biocpkg("IRanges")` and `r Biocpkg("GenomicRanges")` and the data structure they use.

We assume an understanding of the `IRanges` and `GRanges` data structures.
...
Many XXList exists exists in the two packages.
