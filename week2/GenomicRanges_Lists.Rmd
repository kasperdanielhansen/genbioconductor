...
The `r Biocpkg("IRanges")` and `r Biocpkg("GRanges")` packages introduced a number of classes I'll call `XXLists`; an example is `GRangesLists`.
...
```{r CreateGrangesList}
gr1 <- GRanges(seqnames = "chr1", ranges = IRanges(start = 1:10, width = 3))
gr2 <- GRanges(seqnames = "chr2", ranges = IRanges(start = 1:10, width = 3))
...
There are many other types of `XXLists`, including
