...
For example, `resize()` can be extremely useful.  It has a `fix` argument controling where the resizing occurs from.  Use `fix="center"` to resize around the center of the ranges; I use this a lot.
